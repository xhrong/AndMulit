...
import com.xhr.andmulti.encoder.Encoder;
import com.xhr.andmulti.encoder.VideoEncodeConfig;
import com.xhr.andmulti.encoder.VideoEncoder;
...
public class ScreenRecorder {
    ...
    public ScreenRecorder(VideoEncodeConfig video,
        ...
        mAudioEncoder = new AudioRecorder(audio);
    ...
    private void prepareAudioEncoder() throws IOException {
        Recorder.Callback callback = new Recorder.Callback() {
            boolean ranIntoError = false;
            ...
            @Override
            public void onOutputBufferAvailable(Recorder codec, int index, MediaCodec.BufferInfo info) {
                if (VERBOSE)
            ...
            @Override
            public void onOutputFormatChanged(Recorder codec, MediaFormat format) {
                if (VERBOSE)
            ...
            @Override
            public void onError(Recorder codec, Exception e) {
                ranIntoError = true;
